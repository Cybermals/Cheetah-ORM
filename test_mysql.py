"""Cheetah ORM - MySQL/MariaDB Unit Tests"""
...
class TestMySQLDBDriver(unittest.TestCase):
    """MySQL/MariaDB database driver tests."""
    @classmethod
    def setUpClass(cls):
    ...
    def test_1_model(self):
        ...
        self.assertEqual(n._insert_sql, "INSERT INTO numbers(num1, num2) VALUES (%s, %s);")
        self.assertEqual(mn._insert_sql, "INSERT INTO more_numbers(num3, num4, num5) VALUES (%s, %s, %s);")
