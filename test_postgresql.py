"""Cheetah ORM - PostgreSQL Unit Tests"""
...
#Classes
#=======
class TestPostgreSQLDBDriver(unittest.TestCase):
    ...
    def test_1_model(self):
        ...
        self.assertEqual(n._insert_sql, "INSERT INTO numbers(num1, num2) VALUES (%s, %s) RETURNING id;")
        self.assertEqual(mn._insert_sql, "INSERT INTO more_numbers(num3, num4, num5) VALUES (%s, %s, %s) RETURNING id;")
    ...
    def test_3_field_modification(self):
        """Test PostgreSQL field modification."""
        from cheetah_orm.db import DataModel, fields
    ...
    def test_4_filtering(self):
        """Test PostgreSQL model filtering."""
        from cheetah_orm.db import DataModel, fields
    ...
    def test_7_drop_table(self):
        """Test dropping a PostgreSQL table."""
